  ...
  return (
    <div style={{ marginLeft: "50px" }}>
      <form onSubmit={handleSubmit} style={{}}>
        ...
        <input
          onChange={(e) => {
            onHandelChange(e, "firstname");
          }}
          onBlur={(event) => {
            onBlurChange(event, "firstname");
          }}
        ...
        <input
          onChange={(e) => {
            onHandelChange(e, "email");
          }}
          onBlur={(event) => {
            onBlurChange(event, "email");
          }}
          type="email"
        />
        ...
        <input
          onChange={(e) => {
            onHandelChange(e, "phonenum");
          }}
          onBlur={(event) => {
            onBlurChange(event, "phonenum");
          }}
          type="number"
        />
